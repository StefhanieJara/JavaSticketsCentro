...
@WebServlet(name = "OperadorEditaPerfilServlet", value = "/OperadorEditaPerfilServlet")
public class OperadorEditaPerfilServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action){
            case "editarPerfil":
                RequestDispatcher requestDispatcher = request.getRequestDispatcher("Operador/OperadorEditaPerfil.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            case "actualizar":
                ...
                response.sendRedirect(request.getContextPath()+"/OperadorEditaPerfilServlet");
                break;
            case "actualizarFoto":
