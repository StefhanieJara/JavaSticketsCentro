...
<head>
    ...
    />
    <title>Centro Cultural PUCP - Editar personal</title>
    ...
    <nav class="navbar navbar-light navbar-expand-md fixed-top navbar- shadow-sm navigation-clean-search d-flex justify-content-center"
        ...
        <div class="row w-100 align-items-center d-sm-flex d-flex pe-sm-4 ps-0 my-2">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-5 col-6 d-flex justify-content-center ps-2 ps-md-5 ps-lg-4 ps-xl-5 ps-xxl-2">
                <a href="indexOperadorServlet"><img src="img/logo.png"with="188px" height="97px"/></a>
            </div>
        ...
        <div class="row justify-content-center align-items-center h-100">
            <div class="col-12 col-lg-9 col-xl-7">
                ...
                >
                    ...
                    >
                        <h4 class="my-8">Editar personal de Mantenimiento</h4>
                    </div>
                    <div class="card-body p-4 p-md-5">
                        <form method="POST" action="<%=request.getContextPath()%>/personalServlet?action=actualizar">
                            <input type="hidden"
                                   name="idPersonal"
                                   class="form-control"
                                   value="<%=bPersonal.getIdPersonal()%>"/>
